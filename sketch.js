...
winpop=createSprite(windowWidth/2,windowHeight/2)
...
if(gameState==="play"){
  ...
  text("Got Lucky " +coinscore+" Times",windowWidth/1.7-50,100)
}
if (gameState==="wait")
{
  fill("red")
